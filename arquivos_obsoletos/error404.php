...
@keyframes flicker4{
  0%  {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  30% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  31% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  32% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  36% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  37% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  41% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  42% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  85% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  86% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  95% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  96% {color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
  100%{color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
}

@keyframes fadeInText{
  1%  {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  70% {color: #05fc3b;text-shadow:0px 0px 14px #05fc3b;}
  100%{color: #05fc3b;text-shadow:0px 0px 4px #05fc3b;}
}
