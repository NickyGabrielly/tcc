...
<html lang="pt-br">
	<head>
		...
		<!--https://pt.stackoverflow.com/questions/392268/css-para-impress%C3%A3o-como-controlar-o-fluxo-de-dados vê se isso ajuda no erro do estrapolamento da folha-->
		<style>
	...
	<body>
		<nav>
			<?php
	            ...
	            //echo" - ".$exibe_os['problema']." ".$exibe_user['nome']." ".$exibe_evento['id_equipamento']." ".$exibe_equipamento['n_patrimonio'];
				?>
		</nav>


		<div class="align-btn btn-pc">
			<button onclick="window.location.href='exibe_equipamento.php'" class="btn-none btn"><i class="bi bi-stars"></i> VOLTAR <i class="bi bi-stars"></i></button>
			&nbsp;&nbsp;&nbsp;&nbsp;
