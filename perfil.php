                    ...
                    <div class="fundo1">
                        <div class="alinhar1">';
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12" id="p-r">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input name="senha" type="password" min-lenght="8" class="form-control" placeholder="No mínimo 8 caracteres"> <br>
                                        </div>
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-12 botao-att-align">
                                            <input type="submit" value="Atualizar" id="botao-att" class="btn form-control form-control-file" onclick="return validar()">
                                        </div>
                                    </div>
                                </div>
                            </form>';   
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">';
                                if($perfil["foto"] == ""){
                                    echo 
                                        '<a href="#" data-dismiss="modal" data-toggle="modal" data-target="#upload'.$perfil['id_usuario'].'">
                                        <img id="img-modal" src="imgs/semfoto.jpg" width="200" height="200" alt="Sem foto" align = "center" ></a>';
                                        
                                 }
                                 else{
                                     echo 
                                        '<a href="#" data-dismiss="modal" data-toggle="modal" data-target="#upload'.$perfil['id_usuario'].'">
                                            <img id="img-modal" src="imgs/'.$perfil["foto"].'" width="95" height="95" alt="Foto de'.$perfil['nome'].'" style="object-fit: cover;" align = "center" >
                                        </a>';                     
                                    };
                            echo'<hr>
                            <h6>Nova Foto:</h6>
                       
                        <form name="upload" action="grava_foto_perfil.php" method="post" enctype="multipart/form-data">
